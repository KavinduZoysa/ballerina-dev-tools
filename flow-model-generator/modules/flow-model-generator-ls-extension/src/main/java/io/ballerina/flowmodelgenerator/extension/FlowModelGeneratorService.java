...
import io.ballerina.servicegenerator.http.ResourceSourceGenerator;
...
public class FlowModelGeneratorService implements ExtendedLanguageServerService {
    ...
    @JsonRequest
    public CompletableFuture<FlowModelSourceGeneratorResponse> getHttpResourceSourceCode(
            FlowModelSourceGeneratorRequest request) {

        return CompletableFuture.supplyAsync(() -> {
            FlowModelSourceGeneratorResponse response = new FlowModelSourceGeneratorResponse();
            try {
                ResourceSourceGenerator resourceSourceGenerator = new ResourceSourceGenerator();
                response.setTextEdits(resourceSourceGenerator.toSourceCode(request.diagramNode()));
            } catch (Throwable e) {
                throw new RuntimeException(e);
                //TODO: Handle errors generated by the flow model generator service.
            }
