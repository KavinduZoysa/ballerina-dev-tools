...
/**
 * Represents a class initialization node in the flow model.
 *
 * @since 2.0.0
 */
public class ClassInitBuilder extends NodeBuilder {

    private static final String CLASS_INITIALIZATION_LABEL = "Class Initialization";
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(ClassInitBuilder.class);

    @Override
    public void setConcreteConstData() {
        metadata().label(CLASS_INITIALIZATION_LABEL);
    ...
    public Map<Path, List<TextEdit>> toSource(SourceBuilder sourceBuilder) {
        ...
        // TODO: Check the file, this should be main.bal
